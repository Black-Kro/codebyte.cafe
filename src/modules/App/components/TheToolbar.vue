<template>
  <kro-toolbar class="[ the-toolbar ]" raised>
    <div
      class="[] [ container mx-auto px-4 ] [ grid grid-cols-4 lg:grid-cols-9 gap-4 items-center ]"
    >
      ...
      <div
        class="[] [ col-span-2 ] [ grid grid-flow-col gap-2 justify-end items-center ]"
      >
        <app-language-selector />
        <kro-menu left>
          <template #activator="{ open }">
            <kro-button icon="mdi:theme-light-dark" @click="open" />
          </template>
          <div>
            <kro-list-item
